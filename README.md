...
| `registration-role.enum.ts` | Numeric role enum, string select-value type, and explicit dropdown option list. |
| `registration-role-label.pipe.ts` | Converts stored role values to display labels. |
